-- Day 16: JOINs Part 2: CROSS and Self - Setup Script
-- 30 Day SQL Challenge | Stephen | Data

-- ============================================
-- DAY 16 SETUP: Airports & flights
-- ============================================
-- This creates a small flights dataset with:
--   - A short list of airport cities (for CROSS JOIN - every origin x destination route)
--   - A flights table (for self joins - connecting flights via a hub, and same-route
