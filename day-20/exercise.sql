-- Day 20: Data Modelling and Star Schema - Exercise Script
-- 30 Day SQL Challenge | Stephen | Data
--
-- Creates ONLY the exercise tables. If you have already run setup.sql you do
-- not need this file - setup.sql builds the teaching AND the exercise tables.
