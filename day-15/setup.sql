...
-- ============================================
-- DAY 15 SETUP: Streaming playlists data
-- ============================================
-- Teaching tables: users, songs, playlist_tracks
-- Exercise tables: incidents, responder_units, dispatches, hospital_capacity
...
-- TABLE 1: users
-- ============================================
-- Each row is one person on the streaming platform
...
-- TABLE 2: songs
-- ============================================
-- Each row is one song available on the platform
